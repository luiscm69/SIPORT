...
{
    public static class EncriptadorExtensions
    {
        //private const string Semilla = "TAURO2015";

        public static string DecryptText(string strText)
        {
            //string llave = "TAURO2015";

            string plainText = strText;    // original plaintext
        ...
        //private static string Decrypt(string stringToDecrypt, byte[] key, byte[] IV)
        //{
        ...
        //private static string Encrypt(string stringToEncrypt, byte[] key, byte[] IV)
        //{
